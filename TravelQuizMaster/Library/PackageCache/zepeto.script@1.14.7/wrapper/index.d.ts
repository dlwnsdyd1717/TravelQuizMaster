...
declare module 'ZEPETO.Script' {
    ...
    class ZepetoScriptBehaviour extends System.Object {
        ...
        public static op_Equality($rhs: ZepetoScriptBehaviour, $lhs: ZepetoScriptBehaviour):boolean;
        
        public static op_Inequality($rhs: ZepetoScriptBehaviour, $lhs: ZepetoScriptBehaviour):boolean;
