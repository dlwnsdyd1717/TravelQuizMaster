Shader "ZEPETO/BuiltIn/Cloth"
{
    Properties
    {
        ...
        // _CLOTH
        [HDR]_SheenColorFactor("Sheen Color", Color) = (0,0,0)
        _SheenColorMap("Sheen Texture", 2D) = "white" {}
        _SheenRoughnessFactor("Sheen Roughness", Range(0.0, 1.0)) = 0.0
        _SheenRoughnessMap("Sheen Roughness Texture", 2D) = "white" {}
...
ENDCG
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "CGIncludes/ZepetoClothCoreForward.cginc"
