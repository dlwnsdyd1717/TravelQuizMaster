Shader "ZEPETO/BuiltIn/FurSpec"
{
	...
	{        
        ...
        [Gamma]_SpecColor("Specular",  Color) = (0.2,0.2,0.2,1)
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surfSpecular StandardSpecular fullforwardshadows exclude_path:deferred nolightmap nometa vertex:vert finalcolor:tonemappingSpecular
		#pragma target 3.0
		...
		CGPROGRAM
		#pragma surface surfSpecular StandardSpecular keepalpha fullforwardshadows exclude_path:deferred nolightmap nometa vertex:vert finalcolor:tonemappingSpecular
		#pragma target 3.0
		#pragma shader_feature_local_fragment COLORGRADING_OFF //Colorgrading
        #pragma shader_feature_local_fragment RIMLIGHT_DIRECTIONALFRESNEL_OFF //DIRECTIONALFRESNEL
