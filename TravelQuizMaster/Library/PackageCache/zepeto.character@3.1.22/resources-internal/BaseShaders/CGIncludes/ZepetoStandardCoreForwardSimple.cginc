...
#ifndef ZEPETO_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
#define ZEPETO_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED

#include "ZepetoStandardCore.cginc"

//  Does not support: _PARALLAXMAP, DIRLIGHTMAP_COMBINED
//#define GLOSSMAP (defined(_METALLICGLOSSMAP))
...
#define UNIFORM_REFLECTIVITY JOIN(MetallicSetup, _Reflectivity)
...
FragmentCommonData FragmentSetupSimple(VertexOutputBaseSimple i)
{
    ...
    FragmentCommonData s = MetallicSetup(i.tex);
...
#endif // ZEPETO_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
