...
#ifndef ZEPETO_SPARKLE_CORE_FORWARD_INCLUDED
#define ZEPETO_SPARKLE_CORE_FORWARD_INCLUDED
...
#include "ZepetoSparkleNoise.cginc"
    ...
    half4 fragForwardBaseSimpleInternalGrading (VertexOutputBaseSimple i)
    {
        ...
        c += Emission(i.tex.xy);
        c.rgb += computeSparkle(i.tex.xy, s.specColor, gi.light.dir, s.normalWorld, -s.eyeVec);
...
#endif // ZEPETO_SPARKLE_CORE_FORWARD_INCLUDED
