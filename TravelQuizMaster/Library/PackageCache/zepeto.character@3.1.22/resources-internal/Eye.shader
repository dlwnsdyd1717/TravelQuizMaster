Shader "ZEPETO/Eye"
{
	...
	SubShader{
		...
		#pragma surface surf Lambert exclude_path:deferred nolightmap nofog noforwardadd noshadow novertexlights
		
		#pragma multi_compile_local __ BLEND_MULTIPLY BLEND_OVERLAY BLEND_SCREEN
		#pragma multi_compile_local __ ODD_EYE
		#pragma multi_compile_local __ USE_LENS
