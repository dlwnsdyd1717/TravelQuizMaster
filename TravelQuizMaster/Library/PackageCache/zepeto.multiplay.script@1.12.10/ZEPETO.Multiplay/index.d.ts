...
declare module 'ZEPETO.Multiplay' {
    ...
    class SchemaBase extends System.Object {
        ...
        public Decode($bytes: number[], $it: $Ref<number>, $referenceTracker?: ReferenceTracker, $forceCollectionEvent?: boolean):void;
    ...
    class RoomBase extends System.Object {
        ...
        public add_OnConnected($value: ColyseusOpenEventHandler):void;
        
        public remove_OnConnected($value: ColyseusOpenEventHandler):void;
        ...
        public Leave():System_Threading_Tasks.Task;
        
        public Disconnect():void;
        
        public SetConnection($connection: TransportBase):void;
    ...
    enum RoomMethod { joinById = 0, create = 1, joinOrCreate = 2 }
    
    enum TransportState { Connecting = 0, Open = 1, Closing = 2, Closed = 3 }
